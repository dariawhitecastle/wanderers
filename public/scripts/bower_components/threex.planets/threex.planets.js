...
THREEx.Planets.baseURL	= '/scripts/bower_components/threex.planets/'
...
THREEx.Planets.createJupiter	= function(){
	...
	var texture	= THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/realj4k.jpg')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 4,
...
THREEx.Planets.createSaturn	= function(){
	...
	var texture	= THREE.ImageUtils.loadTexture(THREEx.Planets.baseURL+'images/th_saturn.png')
	var material	= new THREE.MeshPhongMaterial({
		map	: texture,
		bumpMap	: texture,
		bumpScale: 3,
...
THREEx.Planets.createStarfield	= function(){
	...
	var geometry	= new THREE.SphereGeometry(15000, 32, 32)
	var mesh	= new THREE.Mesh(geometry, material)
	return mesh
}
